...
const Home = () => {
    ...
    return (
        <Box component="section" className="hero">
            ...
            <Typography component="p" sx={{ margin: "20px 0 0", maxWidth: "540px" }}>I&apos;m a software developer with a focus on building accessible web products. Welcome to my page.</Typography>
